...
func TestCreateStakeSignVerify(t *testing.T) {
	...
	hash := selp.Hash()
	require.Equal("080118c0843d22023130c2023d0a29696f3178707136326177383575717a72636367397935686e727976386c64326e6b7079636333677a611202313018e80720012a077061796c6f6164", hex.EncodeToString(hash[:]))
	// verify signature
