...
func main() {
	...
	for i := 0; i < numNodes; i++ {
		...
		stakingIndexDBPath := fmt.Sprintf("./staking.index%d.db", i+1)
		dbFilePaths = append(dbFilePaths, stakingIndexDBPath)
		networkPort := 4689 + i
		apiPort := 14014 + i
		...
		config.Chain.StakingIndexDBPath = stakingIndexDBPath
...
func newConfig(
	...
	cfg.Chain.EnableStakingIndexer = true
	...
	cfg.Genesis.GreenlandBlockHeight = 100
