...
lint-rich:
	...
	$(ECHO_V)golangci-lint run $(VERBOSITY_FLAG)--enable-all -D gochecknoglobals -D prealloc -D lll -D interfacer -D scopelint -D maligned -D dupl -D gocyclo -D gochecknoinits| tee -a $(LINT_LOG)
